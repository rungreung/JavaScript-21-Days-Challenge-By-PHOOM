(() => {
  ...
  function drawSnowBall(canvasContext, snowBall) {
    ...
    canvasContext.arc(snowBall.x, snowBall.y, snowBall.radis, 0, Math.PI * 2);
  ...
  function run() {
    ...
    setInterval(() => {
      canvasContext.clearRect(0, 0, canvas.width, canvas.height); // clear after create & move
